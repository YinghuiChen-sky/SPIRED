...
def generate_esm1v_logits(model, batch_converter, alphabet, seq_data, device="cpu"):
...
def getDataTest(seq, ESM2_3B, ESM2_650M, ESM1v_1, ESM1v_2, ESM1v_3, ESM1v_4, ESM1v_5, esm1v_batch_converter, esm1v_alphabet, esm2_batch_converter, device="cpu"):
    ...
    with torch.no_grad():
        ...
        esm1v_single_1, esm1v_double_1 = generate_esm1v_logits(ESM1v_1, esm1v_batch_converter, esm1v_alphabet, [("", seq)], device=device)
        esm1v_single_2, esm1v_double_2 = generate_esm1v_logits(ESM1v_2, esm1v_batch_converter, esm1v_alphabet, [("", seq)], device=device)
        esm1v_single_3, esm1v_double_3 = generate_esm1v_logits(ESM1v_3, esm1v_batch_converter, esm1v_alphabet, [("", seq)], device=device)
        esm1v_single_4, esm1v_double_4 = generate_esm1v_logits(ESM1v_4, esm1v_batch_converter, esm1v_alphabet, [("", seq)], device=device)
        esm1v_single_5, esm1v_double_5 = generate_esm1v_logits(ESM1v_5, esm1v_batch_converter, esm1v_alphabet, [("", seq)], device=device)
