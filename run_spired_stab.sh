...
help() {
    echo -e "Usage:\n"
    echo -e "bash run_spired_stab.sh [-i INPUT] [-m MODEL_DIR] [-o FOLDER] [-d DEVICE]\n"
    echo -e "Description:\n"
...
python ${SPIRED_DIR}/run_SPIRED-Stab.py --fasta_file ${input} --model_dir ${model_dir} --saved_folder ${folder} --device ${device}
